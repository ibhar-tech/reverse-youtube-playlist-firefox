...
ZIP_NAME="youtube-playlist-tools-edge-v${VERSION}.zip"
ZIP_PATH="$SCRIPT_DIR/$ZIP_NAME"
BUILD_DIR="$SCRIPT_DIR/build_temp_edge"

echo "▶  Building $ZIP_NAME for Edge / Chromium..."
...
# Copy docs if needed by popup? No, docs are not needed in extension bundle.

# Process manifest (remove browser_specific_settings)
...
echo "You can now upload this zip file to the Microsoft Edge Partner Center."
